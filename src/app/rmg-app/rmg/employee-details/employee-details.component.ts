...
export class EmployeeDetailsComponent implements OnInit {
  ...
  'Row Id', 'Emp Id', 'Project Name', 'Account Name', 'Allocation Start Date', 'Allocation End Date', 'Last Working Day', 'Allocation Status',
  'Skill Master Id', 'Emp Id', 'Skill', 'Skill Rating', 'Skill Category', 
  'Row Id', 'Emp Id', 'Technology', 'Certification', 'Borad Institute', 'Valid From', 'Valid To', 'Comments',
  'Row Id', 'Emp Id', 'Domain Name', 'Sub Domain Name', 'Child Domain Name', 'Domain Experience', 'Comments', 
  'Row Id', 'Emp Id', 'Visa', 'Visa Type', 'Country', 'Status', 'Valid To', 'Valid From'];
  private csvBodyData = [
    {
            "empBean": {
                "emp_id": "E001441",
  ...
  parseJson(data) {
    ...
    for (let i = 0; i < array.length; i++) {
      for (let index in array[i]) {
        this.prepareCSVBody(array[i][index]);
      }
      this.csvBodyRow += '\r\n' + this.csvHeaderRow;
      this.csvHeaderRow = '';
    }
